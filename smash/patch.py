...
# The four instructions expected at the BGM hook site and the two at the
# function's epilogue, both replayed by island_sdbgm.s and checked before
# anything is written. Hooking after the track name resolves, rather than
# overwriting one of the three base pointers, keeps the rom:/patch tier and
# allows more than one directory.
