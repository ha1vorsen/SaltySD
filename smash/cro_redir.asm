...
; r0=table name, r5=ID
; Weapon classes keep the table's spelling, except where the game creates a
; differently named class than the table lists
...
cro_file_size_intercept:
   push {r1-r6, lr}
      ...
      ; Ask the payload which root supplies cro/<path>; it writes the finished
      ; path and answers its length, or 0 when no mod has the file.
      mov r1, #0x300
